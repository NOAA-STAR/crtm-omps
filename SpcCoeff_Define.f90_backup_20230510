...
MODULE SpcCoeff_Define
  ...
  TYPE :: SpcCoeff_type
    ...
    REAL(Double) , ALLOCATABLE :: AllFrequency(:,:)                   ! L x nFOVs
    REAL(Double) , ALLOCATABLE :: AllWavenumber(:,:)                  ! L x nFOVs
    REAL(Double) , ALLOCATABLE :: AllSolar_Irradiance(:,:)            ! L x nFOVs
