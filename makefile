...
#prefix = /data/data553/qliu/CRTM_V3.0beta.20201116/REL-3.0beta
prefix = /data/data553/qliu/JCSDA2/crtm
...
FC      = ifort
FCFLAGS = -convert big_endian -O3 -fp-model source -e08 -free -qopenmp -assume byterecl,realloc_lhs -c
